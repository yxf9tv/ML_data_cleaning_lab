...
def split_train_tune_test(df, train_size=0.7, tune_size=0.15, random_state=42):
    ...
    # Second split: Tune vs Test (50/50 of remaining)
...
def prepare_college_aid_pipeline(filepath="cc_institution_details.csv"):
    ...
    train_df, tune_df, test_df = split_train_tune_test(df)
